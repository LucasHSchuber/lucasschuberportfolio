...
<div class="row py-5 container-fluid projekt">
  ...
  <div class="order-item2 container col-md-7 text1">
    ...
    <P>
      Gjorde en etnografisk studie på hur bokningen vid Stockholms utomhuspadelbanor går till och designade därefeter en applikation för bokning och sökandet efter motstånd.
    </P>
