...
<nav class="navbar navbar-expand-lg fixed-top" id="navbarNavAltMarkup">
   <div class="container-fluid">
      <a class="navbar-brand" href="indextest.php"><img src="assets/images/hem.png" class="card-img-top househome" alt="..."></a>
   ...
   // When the user scrolls down 80px from the top of the document.
        ...
        function scrollFunction() {
          if (document.body.scrollTop > 75 || document.documentElement.scrollTop > 75) {
            document.getElementById("navbarNavAltMarkup").style.backgroundColor = "rgba(255, 255, 255, 1)";
            document.getElementById("dropdown-menu").style.backgroundColor = "rgba(255, 255, 255, 1)";
