        ...
        <div class="wrapper">
            ...
            <div class="row aboutgoal">
                ...
                <div class="col-md-6">
                    ...
                    <P>
                        I detta projekt, i kursen hette Webbutveckling - grafisk teknik, skulle alla bilder, logotyper och illustrationer skapas av oss själva och hemsidan skulle kodas i HTML/CSS/JAVASCRIPT och vara responsiv.
                    </P>
                </div>
            </div>
            ...
            <div class="order row py-5 container-fluid">
                <div class="order-item2 card container col-md-6 portfolio-card" style="width: 20rem;">
                    <img src="assets/images/nordfjallfigma.jpg" class="card-img-top py-3" alt="...">
                </div>
                <div class="order-item1 container col-md-5 content align-self-center">
                    ...
                    <p>
                        En enkel prototyp i Figma för dator.
                    </p>
                    <div class="videolink">
                        <p>
                            Klicka på knappen för att se prototypen:
                        </p>
                        <a class="btn btn-lg" href="https://www.figma.com/file/Bp3QEwwOECuxULoBymLo1H/Datateknik-projekt?type=design&node-id=0%3A1&t=SBQ7bQ6mvARTV264-1" role="button" rel="noreferrer noopener" target="_blank">Dator</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row py-5 container-fluid">
                <div class="container col-md-5 content">
                    ...
                    <div class="videolink">
                        ...
                        <a class="btn btn-lg" href="http://studenter.miun.se/~luha2200/DATATEKNIK/projekt_datateknik/index.html" role="button" rel="noreferrer noopener" target="_blank">Hemsidan</a>
                    </div>
                </div>
